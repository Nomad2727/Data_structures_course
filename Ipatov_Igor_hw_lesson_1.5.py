...
letter1 = input('Введите первую букву диапазона: ')
letter2 = input('Введите вторую букву диапазона: ')
...
print(f'Между ними находятся {abs(index_letter1 - index_letter2) - 1} букв \
